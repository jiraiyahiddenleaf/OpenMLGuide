...
- [EfficientNet](https://arxiv.org/abs/1905.11946) (2019): A convolutional neural network architecture using a scaling method that balances network depth, width, and resolution. EfficientNet achieved state-of-the-art accuracy on ImageNet with significantly fewer parameters.
