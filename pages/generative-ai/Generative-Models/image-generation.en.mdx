...
- [Image Prompting](https://learnprompting.org/docs/category/%EF%B8%8F-image-prompting) by Learn Prompting
...
- [NeRF: Representing Scenes as Neural Radiance Fields for View Synthesis](https://arxiv.org/abs/2003.08934) (2020)

- [DreamFusion: Text-to-3D using 2D diffusion](https://arxiv.org/pdf/2209.14988.pdf) (2022)