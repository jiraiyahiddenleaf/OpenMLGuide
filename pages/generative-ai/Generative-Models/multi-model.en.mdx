...
- [LLaVA](https://llava-vl.github.io/) (2023): LLaVA-1.5 excels in 11 benchmarks with minimal changes from LLaVA, using only public data, quick training in ~1 day on a single 8-A100 node, and outperforming billion-scale data methods. It's a powerful multimodal model, rivaling GPT-4 in chat capabilities and setting a new Science QA accuracy record. [(code)](https://github.com/haotian-liu/LLaVA) [(pdf)](https://browse.arxiv.org/pdf/2310.03744.pdf) [(paper)](https://arxiv.org/abs/2304.08485)